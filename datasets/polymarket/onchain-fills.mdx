...
You can find available files from the market slug, event slug, or asset id using
api.predictiondata.dev. This will produce a list of records you can use to fetch
data from the datasets api.
