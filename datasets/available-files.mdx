...
**Note:** The event slug is what you see in your address bar when you view a
*polymarket market. Fetching the exports by event slug is easiest, as it will
*show all of the market slugs for that event.
